...
public class AccountsRepository implements RepositoryContract.Accounts {
  ...
  @Override
  public void getCheckAccount(final String accountName, final String accountPassword,
  ...
  @Override
  public void checkNewAccountDataExist(final String accountDni, final String accountEmail,
  ...
  //----------------------------Métodos de mascotas---------------------------------
  @Override
  public void getUserPetsList(final AccountItem accountItem,
                              final GetUserPetsListCallback callback) {
  ...
  private boolean loadZongetFromJSON(String json) {
    ...
    try {
      ...
      if (jsonArray.length() > 0) {
        ...
        final List<AccountItem> accounts = Arrays.asList(gson.fromJson(jsonArray.toString(),
                AccountItem[].class));
