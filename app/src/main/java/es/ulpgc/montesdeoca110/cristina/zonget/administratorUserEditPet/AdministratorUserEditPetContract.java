...
interface AdministratorUserEditPetContract {
  ...
  interface Model {
    ...
    /**
     * Metodo que la pasa al repositorio la nueva mascota para cambiar la que ya se encuentra
     * en la BD con ese ID por la nueva
     *
     * @param userPetItem:              Nueva mascota a añadir
     * @param updateNewUserPetCallback: Callback que realizara las operaciones
     */
    void editPet(UserPetItem userPetItem, RepositoryContract.Accounts.UpdateUserPetCallback
            updateNewUserPetCallback);
  }
