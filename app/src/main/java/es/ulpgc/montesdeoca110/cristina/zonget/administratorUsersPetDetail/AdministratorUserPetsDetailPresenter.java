...
public class AdministratorUserPetsDetailPresenter
        implements AdministratorUserPetsDetailContract.Presenter {
  ...
  private final AdministratorUserPetsDetailViewModel viewModel;
