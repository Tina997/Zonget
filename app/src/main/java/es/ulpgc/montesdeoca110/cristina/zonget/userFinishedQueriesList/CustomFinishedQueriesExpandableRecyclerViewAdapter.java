...
public abstract class CustomFinishedQueriesExpandableRecyclerViewAdapter extends ExpandableRecyclerViewAdapter<CustomFinishedQueriesExpandableRecyclerViewAdapter.QueryViewHolder, CustomFinishedQueriesExpandableRecyclerViewAdapter.QueryDataViewHolder> {
  ...
  CustomFinishedQueriesExpandableRecyclerViewAdapter
          (Context context, List<? extends ExpandableGroup> groups) {
    super(groups);
  ...
  public QueryViewHolder onCreateGroupViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(context)
            .inflate(R.layout.user_finished_queries_list, parent, false);
  ...
  public QueryDataViewHolder onCreateChildViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(context)
            .inflate(R.layout.user_finished_queries_list_content, parent, false);
    return new QueryDataViewHolder(view);
  }

  @Override
  public void onBindGroupViewHolder
          (CustomFinishedQueriesExpandableRecyclerViewAdapter.QueryViewHolder holder,
           int flatPosition, ExpandableGroup group) {
    holder.setQueryTitle(group);
  }

  @Override
  public void onBindChildViewHolder(QueryDataViewHolder holder,
