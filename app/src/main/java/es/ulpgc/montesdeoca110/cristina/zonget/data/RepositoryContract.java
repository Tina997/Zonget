...
public interface RepositoryContract {
  ...
  interface Accounts {
    ...
    /**
     * Este método obtiene el nombre de un usuario a partir de la id.
     *
     * @param id       identificador del usuario que desea buscar.
     * @param callback Que posteriormete actualizará la información en la activity.
     */
    void getUserName(final int id, final GetUserNameCallback callback);

    interface GetUserNameCallback {
      /**
       * Este método actualiza el nombre de usuario de una consulta con el nombre pasado
       * por parámetro
       *
       * @param userName Nombre o DNI del usuario que desea buscar.
       */
  ...
  interface Queries {
    ...
    /**
     * Este método obtiene la lista de consultas destinadas al administrador.
     *
     * @param callback Que posteriormete actualizará la información en la activity.
     */
    ...
    interface GetAdministratorQueriesListCallback {
      ...
      /**
       * Este método se encarga de actualizar la lista de consultas del
       * viewmodel del buzón con la pasada por parámetro.
       *
       * @param administratorQueryList Lista de consultas del administrador.
       */
      void setAdministratorQueriesList(List<QueryItem> administratorQueryList);
    }

    /**
     * Este método añade una respuesta a la consulta.
     *
     * @param query    La consulta a la que se va a añdir una respuesta.
     * @param answer   La respuesta a la consulta
     * @param callback Que posteriormete informará al usuario.
     */
    ...
    interface SetQueryAnswerCallback {
      /**
       * Este método se encarga de informar al usuario de si ha habido algún problema al
       * insertar o no la respuesta en la base de datos
       *
       * @param correct Indica si la respuesta se insertó en la base de datos correctamente.
       */
