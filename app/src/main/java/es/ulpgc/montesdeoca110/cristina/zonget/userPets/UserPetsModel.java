...
public class UserPetsModel implements UserPetsContract.Model {
  ...
  @Override
  public void fetchPetsData(final AccountItem item, final RepositoryContract.Accounts
  ...
  /*
    ...
    private PetsItem createPet(int posicion) {
        ...
        return new PetsItem(posicion, content, fetchSpecies(posicion),
        fetchBreed(posicion), fetchChipNumber(posicion), fetchAnimalNac(posicion));
    }
